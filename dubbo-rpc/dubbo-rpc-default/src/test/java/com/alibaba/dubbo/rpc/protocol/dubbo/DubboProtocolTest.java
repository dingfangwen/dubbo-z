...
public class DubboProtocolTest
{
	...
	public void testDemoProtocol() throws Exception
	{
		...
		protocol.export(proxy.getInvoker(service, DemoService.class, URL.valueOf("dubbo://10.16.4.95:20880/" + DemoService.class.getName() + "?codec=exchange")));
		service = proxy.getProxy(protocol.refer(DemoService.class, URL.valueOf("dubbo://10.16.4.95:20880/" + DemoService.class.getName() + "?codec=exchange")));
