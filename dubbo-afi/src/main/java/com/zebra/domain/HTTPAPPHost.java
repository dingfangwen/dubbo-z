...
public class HTTPAPPHost {
	...
	public String toString() {
		return this.slice + "|" + this.sliceType + "|" + this.cellid + "|"
				+ this.appType + "|" + this.appSubtype + "|" + this.host + "|"
				+ this.userIP + "|" + this.appServerIP + "|" + this.attempts
				+ "|" + this.accepts + "|" + this.trafficDL + "|"
				+ this.trafficUL + "|" + this.retranDL + "|" + this.retranUL
				+ "|" + this.failCount + "|" + this.transDelay;
	}
